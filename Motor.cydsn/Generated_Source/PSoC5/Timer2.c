...
{
   #if(Timer2_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(Timer2_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG8(Timer2_PERIOD_LSB_PTR));
   #endif /* (Timer2_UsingFixedFunction) */
}
...
void Timer2_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(Timer2_PERIOD_LSB_PTR, period);
...
{
   #if(Timer2_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(Timer2_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG8(Timer2_CAPTURE_LSB_PTR));
   #endif /* (Timer2_UsingFixedFunction) */
}
...
void Timer2_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(Timer2_COUNTER_LSB_PTR, counter);
