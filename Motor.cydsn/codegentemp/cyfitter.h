...
/* Llenar */
#define Llenar__0__INTTYPE CYREG_PICU1_INTTYPE2
#define Llenar__0__MASK 0x04u
#define Llenar__0__PC CYREG_PRT1_PC2
#define Llenar__0__PORT 1u
#define Llenar__0__SHIFT 2u
#define Llenar__AG CYREG_PRT1_AG
#define Llenar__AMUX CYREG_PRT1_AMUX
#define Llenar__BIE CYREG_PRT1_BIE
#define Llenar__BIT_MASK CYREG_PRT1_BIT_MASK
#define Llenar__BYP CYREG_PRT1_BYP
#define Llenar__CTL CYREG_PRT1_CTL
#define Llenar__DM0 CYREG_PRT1_DM0
#define Llenar__DM1 CYREG_PRT1_DM1
#define Llenar__DM2 CYREG_PRT1_DM2
#define Llenar__DR CYREG_PRT1_DR
#define Llenar__INP_DIS CYREG_PRT1_INP_DIS
#define Llenar__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Llenar__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Llenar__LCD_EN CYREG_PRT1_LCD_EN
#define Llenar__MASK 0x04u
#define Llenar__PORT 1u
#define Llenar__PRT CYREG_PRT1_PRT
#define Llenar__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Llenar__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Llenar__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Llenar__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Llenar__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Llenar__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Llenar__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Llenar__PS CYREG_PRT1_PS
#define Llenar__SHIFT 2u
#define Llenar__SLW CYREG_PRT1_SLW

/* Pin_HC */
#define Pin_HC__0__INTTYPE CYREG_PICU2_INTTYPE2
#define Pin_HC__0__MASK 0x04u
#define Pin_HC__0__PC CYREG_PRT2_PC2
#define Pin_HC__0__PORT 2u
#define Pin_HC__0__SHIFT 2u
#define Pin_HC__AG CYREG_PRT2_AG
#define Pin_HC__AMUX CYREG_PRT2_AMUX
#define Pin_HC__BIE CYREG_PRT2_BIE
#define Pin_HC__BIT_MASK CYREG_PRT2_BIT_MASK
#define Pin_HC__BYP CYREG_PRT2_BYP
#define Pin_HC__CTL CYREG_PRT2_CTL
#define Pin_HC__DM0 CYREG_PRT2_DM0
#define Pin_HC__DM1 CYREG_PRT2_DM1
#define Pin_HC__DM2 CYREG_PRT2_DM2
#define Pin_HC__DR CYREG_PRT2_DR
#define Pin_HC__INP_DIS CYREG_PRT2_INP_DIS
#define Pin_HC__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Pin_HC__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Pin_HC__LCD_EN CYREG_PRT2_LCD_EN
#define Pin_HC__MASK 0x04u
#define Pin_HC__PORT 2u
#define Pin_HC__PRT CYREG_PRT2_PRT
#define Pin_HC__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Pin_HC__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Pin_HC__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Pin_HC__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Pin_HC__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Pin_HC__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Pin_HC__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Pin_HC__PS CYREG_PRT2_PS
#define Pin_HC__SHIFT 2u
#define Pin_HC__SLW CYREG_PRT2_SLW

/* Vaciar */
#define Vaciar__0__INTTYPE CYREG_PICU2_INTTYPE3
#define Vaciar__0__MASK 0x08u
#define Vaciar__0__PC CYREG_PRT2_PC3
#define Vaciar__0__PORT 2u
#define Vaciar__0__SHIFT 3u
#define Vaciar__AG CYREG_PRT2_AG
#define Vaciar__AMUX CYREG_PRT2_AMUX
#define Vaciar__BIE CYREG_PRT2_BIE
#define Vaciar__BIT_MASK CYREG_PRT2_BIT_MASK
#define Vaciar__BYP CYREG_PRT2_BYP
#define Vaciar__CTL CYREG_PRT2_CTL
#define Vaciar__DM0 CYREG_PRT2_DM0
#define Vaciar__DM1 CYREG_PRT2_DM1
#define Vaciar__DM2 CYREG_PRT2_DM2
#define Vaciar__DR CYREG_PRT2_DR
#define Vaciar__INP_DIS CYREG_PRT2_INP_DIS
#define Vaciar__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define Vaciar__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define Vaciar__LCD_EN CYREG_PRT2_LCD_EN
#define Vaciar__MASK 0x08u
#define Vaciar__PORT 2u
#define Vaciar__PRT CYREG_PRT2_PRT
#define Vaciar__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define Vaciar__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define Vaciar__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define Vaciar__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define Vaciar__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define Vaciar__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define Vaciar__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define Vaciar__PS CYREG_PRT2_PS
#define Vaciar__SHIFT 3u
#define Vaciar__SLW CYREG_PRT2_SLW
...
/* TimerSensor */
#define TimerSensor_TimerHW__CAP0 CYREG_TMR1_CAP0
#define TimerSensor_TimerHW__CAP1 CYREG_TMR1_CAP1
#define TimerSensor_TimerHW__CFG0 CYREG_TMR1_CFG0
#define TimerSensor_TimerHW__CFG1 CYREG_TMR1_CFG1
#define TimerSensor_TimerHW__CFG2 CYREG_TMR1_CFG2
#define TimerSensor_TimerHW__CNT_CMP0 CYREG_TMR1_CNT_CMP0
#define TimerSensor_TimerHW__CNT_CMP1 CYREG_TMR1_CNT_CMP1
#define TimerSensor_TimerHW__PER0 CYREG_TMR1_PER0
#define TimerSensor_TimerHW__PER1 CYREG_TMR1_PER1
#define TimerSensor_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define TimerSensor_TimerHW__PM_ACT_MSK 0x02u
#define TimerSensor_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define TimerSensor_TimerHW__PM_STBY_MSK 0x02u
#define TimerSensor_TimerHW__RT0 CYREG_TMR1_RT0
#define TimerSensor_TimerHW__RT1 CYREG_TMR1_RT1
#define TimerSensor_TimerHW__SR0 CYREG_TMR1_SR0
